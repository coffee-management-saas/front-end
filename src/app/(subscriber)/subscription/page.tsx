      ...
      <div className="space-y-6">
        <button
          ...
          className={[
            ...
            "bg-neutral-800/80 text-white font-medium group-hover:bg-orange-500 group-hover:text-black group-hover:font-semibold",
            !disabled && !selecting
              ? "hover:bg-neutral-700 group-hover:hover:bg-orange-500"
              : "",
