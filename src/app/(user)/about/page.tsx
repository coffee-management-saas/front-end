                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-gray-600 leading-relaxed text-lg">
                            Được thành lập từ năm 2020, F&B Coffee bắt đầu từ niềm đam mê
                            mãnh liệt với cà phê chất lượng cao và mong muốn tạo ra một không
                            gian ấm cúng cho cộng đồng. Chúng tôi tin rằng mỗi tách cà phê
                            không chỉ là một thức uống, mà là một trải nghiệm, một câu
                            chuyện được kể qua từng hương vị tinh tế.
                        </p>
                        <p className="text-gray-600 leading-relaxed text-lg">
                            Với đội ngũ barista chuyên nghiệp và tâm huyết, chúng tôi cam kết
                            mang đến những sản phẩm tốt nhất từ những hạt cà phê được chọn
                            lọc kỹ càng từ các vùng trồng nổi tiếng trên thế giới.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="container mx-auto px-4 py-16 md:py-24">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div className="text-center">
                        ...
                        <div className="text-gray-600 font-medium">Khách Hàng Thân Thiết</div>
                    </div>
