...
const mockNotifications: Notification[] = [
    {
        ...
        message: "Đơn hàng #12345 của bạn đã được giao thành công. Cảm ơn bạn đã mua hàng!",
    ...
    },
    {
        ...
        message: "Giảm 20% cho tất cả đồ uống size L. Áp dụng từ hôm nay đến hết tuần!",
    ...
    },
    {
        ...
        message: "Bạn đã tích đủ điểm để lên hạng Bạc. Hãy khám phá các ưu đãi mới dành cho bạn!",
    ...
    },
    {
        ...
        message: "Đơn hàng #12344 của bạn đang được chuẩn bị. Dự kiến giao trong 30 phút.",
...
const getNotificationIcon = (type: string) => {
    switch (type) {
        case "order":
            return { icon: <ShoppingBag className="w-5 h-5" />, color: "bg-blue-100 text-blue-600" };
        case "promotion":
            return { icon: <Gift className="w-5 h-5" />, color: "bg-pink-100 text-pink-600" };
        case "rank":
            return { icon: <Star className="w-5 h-5" />, color: "bg-amber-100 text-amber-600" };
        case "system":
                    ...
                    {filteredNotifications.length === 0 ? (
                        ...
                        filteredNotifications.map((notification) => {
                            ...
                            return (
                                <div
                                    key={notification.id}
                                    className={`bg-white rounded-xl p-4 shadow-sm hover:shadow-md transition-all ${!notification.read ? "border-l-4 border-amber-500" : ""
                                        }`}
                                >
